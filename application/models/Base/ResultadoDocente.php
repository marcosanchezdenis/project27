...
Doctrine_Manager::getInstance()->bindComponent('Model_ResultadoDocente', 'doctrine');
 ...
 */
abstract class Model_Base_ResultadoDocente extends Doctrine_Record
{
	public function setTableDefinition()
	{
		$this->setTableName('resultados_docente');
