<?php
class Ins_Builder_Asignatura_DatosPrincipales extends Base_Builder
{
    /**
    ...
    {
        $query = new Ins_QueryObject_Asignatura_NextCodigo();
    ...
    public function generateModels()
    {
        ...
        $asignaturaValidator = new Ins_Validator_Asignatura_DatosPrincipales();
